...
export declare class SystemsApiClient extends BaseApiClient {
    /**
     ...
     */
    listCatalog(): Promise<ApiResponse<SystemCatalogEntry[]>>;
    /**
     ...
     */
    listForCurrentSubproject(): Promise<ApiResponse<SystemHomeCard[]>>;
    /**
     ...
     * no tenant resolves.
     */
    showVertical(vertical: string): Promise<ApiResponse<SystemDetail>>;
    /**
     ...
     */
    listComponents(vertical: string): Promise<ApiResponse<SystemComponent[]>>;
}
//# sourceMappingURL=systems-api-client.d.ts.map