 ...
 */
export class WorkflowModuleApiClient extends BaseApiClient {
  // ---------------------------------------------------------------------------
  // Protocol integration (auth:api)
  // ---------------------------------------------------------------------------

  /** GET `/api/protocol/workflow/all`. (`get.api.protocol.workflow.all`) */
  listProtocolWorkflows(
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<WorkflowProtocolIntegrationResource[]>> {
    return this.get<WorkflowProtocolIntegrationResource[]>(
   ...
   */
  start(
    body: StartCodifyPipelineInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<CodifyPipelineStateResource>> {
    return this.post<CodifyPipelineStateResource>(
   ...
   */
  saveResponse(
    body: SaveCodifyPipelineResponseInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<CodifyPipelineSaveResponseResource>> {
    return this.post<CodifyPipelineSaveResponseResource>(
  ...
  checkPipeline(
    ...
    return this.get<CodifyPipelineStateResource>(
      `/api/workflow/codify-pipeline/check-pipeline/${s}`,
      undefined,
      opts,
    );
  }
  ...
  stop(
    session: CodifyPipelineSessionId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<CodifyPipelineStopResource>> {
    const s = encodeURIComponent(String(session));
    return this.get<CodifyPipelineStopResource>(
      `/api/workflow/codify-pipeline/stop/${s}`,
      undefined,
      opts,
    );
  }
