...
import type { AttachedChallengeId, AttachedChallengeResource, ChallengeId, ChallengeProtocolIntegrationResource, ChallengeResource, ChallengeResultId, ChallengeResultResource, ChallengeTaskOrChainId, ChallengeTaskResource, CreateChallengeInput, RecordVideoInput, RunChallengeInput, RunChallengeResponse, RunGlobalChallengeInput, SetChallengeResultInput, StartChallengeTaskInput } from '../types/modules-challenge';
/**
 ...
 */
export declare class ChallengeModuleApiClient extends BaseApiClient {
    ...
    createChallenge(body: CreateChallengeInput, opts?: ApiRequestOptions): Promise<ApiResponse<ChallengeResource>>;
    ...
    updateChallenge(challenge: ChallengeId, body: Partial<CreateChallengeInput>, opts?: ApiRequestOptions): Promise<ApiResponse<ChallengeResource>>;
    ...
    finishAttachedChallenge(attached: AttachedChallengeId, opts?: ApiRequestOptions): Promise<ApiResponse<AttachedChallengeResource>>;
    /** GET `/api/challenge/get-challenge-global-tasks/{challenge}/{task}`. */
    getChallengeGlobalTasks(challenge: ChallengeId, task: ChallengeTaskOrChainId, opts?: ApiRequestOptions): Promise<ApiResponse<ChallengeTaskResource[]>>;
    /** GET `/api/challenge/get-challenge-tasks/{challenge}/{chain}`. */
    getChallengeTasks(challenge: ChallengeId, chain: ChallengeTaskOrChainId, opts?: ApiRequestOptions): Promise<ApiResponse<ChallengeTaskResource[]>>;
    /** GET `/api/challenge/get-challenge/{challenge}/{chain}`. */
    getChallenge(challenge: ChallengeId, chain: ChallengeTaskOrChainId, opts?: ApiRequestOptions): Promise<ApiResponse<ChallengeResource>>;
    /** GET `/api/challenge/get-global-challenge/{challenge}/{task}`. */
    getGlobalChallenge(challenge: ChallengeId, task: ChallengeTaskOrChainId, opts?: ApiRequestOptions): Promise<ApiResponse<ChallengeResource>>;
    ...
    runChallenge(body: RunChallengeInput, opts?: ApiRequestOptions): Promise<ApiResponse<RunChallengeResponse>>;
    /** POST `/api/challenge/run-global`. (`post.api.challenge.run-global`) */
    runGlobalChallenge(body: RunGlobalChallengeInput, opts?: ApiRequestOptions): Promise<ApiResponse<RunChallengeResponse>>;
    /** POST `/api/challenge/set-result/{result}`. (`post.api.challenge.set-result.item`) */
    setChallengeResult(result: ChallengeResultId, body: SetChallengeResultInput, opts?: ApiRequestOptions): Promise<ApiResponse<ChallengeResultResource>>;
    /** POST `/api/challenge/start-task`. (`post.api.challenge.start-task`) */
    startChallengeTask(body: StartChallengeTaskInput, opts?: ApiRequestOptions): Promise<ApiResponse<RunChallengeResponse>>;
    /** DELETE `/api/challenge/task/destroy/{task}`. (`delete.api.challenge.task.destroy.item`) */
    destroyChallengeTask(task: ChallengeTaskOrChainId, opts?: ApiRequestOptions): Promise<ApiResponse<null>>;
    /** GET `/api/protocol/challenge/all`. (`get.api.protocol.challenge.all`) */
    listProtocolChallenges(opts?: ApiRequestOptions): Promise<ApiResponse<ChallengeProtocolIntegrationResource[]>>;
}
//# sourceMappingURL=modules-challenge-api-client.d.ts.map