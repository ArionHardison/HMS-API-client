 ...
 */
import type { CodifyDealTemplate, CodifyIntent, DealTemplatePipelineStep, DealTemplateStakeholder, DealTemplateSuccessCriterion, DealTemplateSystem } from './codify-domain';
export type { CodifyDealTemplate, CodifyIntent } from './codify-domain';
/** `codify_domains.shape` enum (CodifyDomain::SHAPES). */
export type CodifyDomainShape = 'vertical' | 'city' | 'political' | 'wrapper' | 'agency';
