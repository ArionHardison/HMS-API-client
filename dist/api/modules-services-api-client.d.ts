...
import type { ReleaseServiceSlotInput, ReserveServiceSlotInput, ResolveServiceInput, ResolveServiceResource, ServiceReservationResource } from '../types/modules-services';
/**
 * Public client over `/api/v1/services/*`. Subclasses `BaseApiClient`
 * for token / domain handling.
 */
export declare class ServicesModuleApiClient extends BaseApiClient {
    /**
     ...
     */
    resolve(body: ResolveServiceInput, opts?: ApiRequestOptions): Promise<ApiResponse<ResolveServiceResource>>;
    /**
     ...
     */
    reserve(body: ReserveServiceSlotInput, opts?: ApiRequestOptions): Promise<ApiResponse<ServiceReservationResource>>;
    /**
     ...
     */
    release(body: ReleaseServiceSlotInput, opts?: ApiRequestOptions): Promise<ApiResponse<ServiceReservationResource>>;
}
//# sourceMappingURL=modules-services-api-client.d.ts.map