...
exports.removeItemFromCollectionExample = exports.addItemToCollectionExample = exports.createCollectionExample = exports.getCollectionsExample = exports.searchItemsExample = exports.deleteItemExample = exports.updateItemExample = exports.createItemExample = exports.getItemExample = exports.getItemsExample = void 0;
...
async function getItemsExample() {
    try {
        ...
        const response = await api_1.hmsApiClient.items.getItems({
            status: api_1.ItemStatus.ACTIVE,
            page: 1,
            perPage: 20
        });
...
exports.getItemsExample = getItemsExample;
/**
...
async function getItemExample(itemId) {
    try {
        const response = await api_1.hmsApiClient.items.getItem(itemId);
        if (response.data.success) {
...
exports.getItemExample = getItemExample;
/**
 * Create Item Example
 *
 * This example demonstrates how to create a new item.
 */
async function createItemExample(name, description, price) {
    try {
        const response = await api_1.hmsApiClient.items.createItem({
            name,
            description,
            price,
            status: api_1.ItemStatus.ACTIVE
...
exports.createItemExample = createItemExample;
/**
 * Update Item Example
 *
 * This example demonstrates how to update an existing item.
 */
async function updateItemExample(itemId, updates) {
    try {
        const response = await api_1.hmsApiClient.items.updateItem(itemId, updates);
        if (response.data.success) {
            const updatedItem = response.data.data;
            console.log(`Updated item #${updatedItem.id}: ${updatedItem.name}`);
            // Log what was updated
            Object.keys(updates).forEach(key => {
                console.log(`- Updated ${key}: ${updatedItem[key]}`);
            });
            return updatedItem;
        }
        else {
...
exports.updateItemExample = updateItemExample;
/**
 * Delete Item Example
 *
 * This example demonstrates how to delete an item.
 */
async function deleteItemExample(itemId) {
    try {
        const response = await api_1.hmsApiClient.items.deleteItem(itemId);
        if (response.data.success) {
...
exports.deleteItemExample = deleteItemExample;
/**
 * Search Items Example
 *
 * This example demonstrates how to search for items.
 */
async function searchItemsExample(query, type) {
    try {
        const response = await api_1.hmsApiClient.items.searchItems(query, type);
        if (response.data.success) {
...
exports.searchItemsExample = searchItemsExample;
/**
 ...
 */
// Get all collections
async function getCollectionsExample() {
    try {
        const response = await api_1.hmsApiClient.items.getCollections();
        if (response.data.success) {
...
exports.getCollectionsExample = getCollectionsExample;
// Create a new collection
async function createCollectionExample(name, description) {
    try {
        const response = await api_1.hmsApiClient.items.createCollection({
            name,
            description
        });
        if (response.data.success) {
...
exports.createCollectionExample = createCollectionExample;
// Add an item to a collection
async function addItemToCollectionExample(collectionId, itemId) {
    try {
        const response = await api_1.hmsApiClient.items.addItemToCollection(collectionId, itemId);
        if (response.data.success) {
...
exports.addItemToCollectionExample = addItemToCollectionExample;
// Remove an item from a collection
async function removeItemFromCollectionExample(itemId) {
    try {
        const response = await api_1.hmsApiClient.items.removeItemFromCollection(itemId);
        if (response.data.success) {
...
exports.removeItemFromCollectionExample = removeItemFromCollectionExample;
...
*/ 
//# sourceMappingURL=items-example.js.map