...
export class ActivityModuleApiClient extends BaseApiClient {
  ...
  listLocations(opts?: ApiRequestOptions): Promise<ApiResponse<ActivityLocationResource[]>> {
    return this.get<ActivityLocationResource[]>('/api/activity-location', undefined, opts);
  }

  /** POST `/api/activity-location` — create an activity location. (`activity-location.store`) */
  createLocation(
    body: CreateActivityLocationInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ActivityLocationResource>> {
    return this.post<ActivityLocationResource>('/api/activity-location', body, opts);
  }

  /** GET `/api/activity-location/{activity_location}`. (`activity-location.show`) */
  showLocation(
    activityLocation: ActivityLocationId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ActivityLocationResource>> {
    return this.get<ActivityLocationResource>(
      `/api/activity-location/${encodeURIComponent(String(activityLocation))}`,
      undefined,
      opts,
    );
  }
  ...
  updateLocation(
    activityLocation: ActivityLocationId,
    body: Partial<CreateActivityLocationInput>,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ActivityLocationResource>> {
    return this.put<ActivityLocationResource>(
      `/api/activity-location/${encodeURIComponent(String(activityLocation))}`,
      body,
      opts,
    );
  ...
  bookedEventsDay(
    date: DateString,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<BookedEventsResponse>> {
    return this.get<BookedEventsResponse>(
      `/api/activity/booked-events-day/${encodeURIComponent(date)}`,
      undefined,
      opts,
    );
  }
  ...
  bookedEventsMonth(
    ...
    return this.get<BookedEventsResponse>(
      `/api/activity/booked-events-month/${encodeURIComponent(date)}`,
      undefined,
      opts,
    );
  }
  ...
  confirmBooking(
    ...
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ActivityBookingResource>> {
    return this.post<ActivityBookingResource>('/api/activity/confirm-booking', body, opts);
  }
  ...
  expertFinish(
    ...
    return this.get<ActivityBookingResource>(
      `/api/activity/expert-finish/${encodeURIComponent(String(booking))}`,
      undefined,
      opts,
    );
  }
  ...
  failedService(
    ...
    return this.get<ActivityBookingResource>(
      `/api/activity/failed-service/${encodeURIComponent(String(booking))}`,
      undefined,
      opts,
    );
  }
  ...
  getBookingWindows(
    ...
    week?: number | string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<BookingWindowResource[]>> {
    ...
    return this.get<BookingWindowResource[]>(url, undefined, opts);
  }
  ...
  getPendingAmount(opts?: ApiRequestOptions): Promise<ApiResponse<PendingAmountResource>> {
    return this.get<PendingAmountResource>('/api/activity/get-pending-amount', undefined, opts);
  }
  ...
  getProviders(
    activity: ActivityId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ProviderResource[]>> {
    return this.get<ProviderResource[]>(
      `/api/activity/get-providers/${encodeURIComponent(String(activity))}`,
      undefined,
      opts,
    );
  }
  ...
  handleEvent(body: HandleEventInput, opts?: ApiRequestOptions): Promise<ApiResponse<unknown>> {
    return this.post<unknown>('/api/activity/handle-event', body, opts);
  }

  /** POST `/api/activity/reset-reservation`. (`post.api.activity.reset-reservation`) */
  resetReservation(
    body: ResetReservationInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<unknown>> {
    return this.post<unknown>('/api/activity/reset-reservation', body, opts);
  }

  /** POST `/api/activity/running`. (`post.api.activity.running`) */
  runningActivity(
    body: RunningActivityInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<unknown>> {
    return this.post<unknown>('/api/activity/running', body, opts);
  }

  /** POST `/api/activity/set-reservation`. (`post.api.activity.set-reservation`) */
  setReservation(
    body: SetReservationInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<unknown>> {
    return this.post<unknown>('/api/activity/set-reservation', body, opts);
  }
  ...
  userFinish(
    ...
    return this.get<ActivityBookingResource>(
      `/api/activity/user-finish/${encodeURIComponent(String(booking))}`,
      undefined,
      opts,
    );
  }
  ...
  listCreatorActivities(opts?: ApiRequestOptions): Promise<ApiResponse<ActivityResource[]>> {
    return this.get<ActivityResource[]>('/api/creator-activity', undefined, opts);
  }

  /** POST `/api/creator-activity`. (`creator-activity.store`) */
  createCreatorActivity(
    body: CreateCreatorActivityInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ActivityResource>> {
    return this.post<ActivityResource>('/api/creator-activity', body, opts);
  }

  /** GET `/api/creator-activity/{creator_activity}`. (`creator-activity.show`) */
  showCreatorActivity(
    creatorActivity: ActivityId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ActivityResource>> {
    return this.get<ActivityResource>(
  ...
  updateCreatorActivity(
    creatorActivity: ActivityId,
    body: Partial<CreateCreatorActivityInput>,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ActivityResource>> {
    return this.put<ActivityResource>(
      `/api/creator-activity/${encodeURIComponent(String(creatorActivity))}`,
      body,
      opts,
    );
  ...
  listProtocolActivities(
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ActivityProtocolIntegrationResource[]>> {
    return this.get<ActivityProtocolIntegrationResource[]>('/api/protocol/activity/all', undefined, opts);
  }
  ...
  createServiceLocation(
    body: CreateServiceLocationInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ServiceLocationResource>> {
    return this.post<ServiceLocationResource>('/api/service-location/create', body, opts);
  }

  /** POST `/api/service-location/find`. (`post.api.service-location.find`) */
  findServiceLocation(
    body: FindServiceLocationInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ServiceLocationResource[]>> {
    return this.post<ServiceLocationResource[]>('/api/service-location/find', body, opts);
  }

  /** GET `/api/service-location/location/{location}`. (`get.api.service-location.location.item`) */
  serviceLocationByLocation(
    location: LocationId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ServiceLocationResource[]>> {
    return this.get<ServiceLocationResource[]>(
      `/api/service-location/location/${encodeURIComponent(String(location))}`,
      undefined,
      opts,
    );
  }
  ...
  serviceLocationByService(
    service: ServiceId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ServiceLocationResource[]>> {
    return this.get<ServiceLocationResource[]>(
      `/api/service-location/service/${encodeURIComponent(String(service))}`,
      undefined,
      opts,
    );
  }
  ...
  destroyServiceLocationByService(
    service: ServiceId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<null>> {
    return this.delete<null>(
  ...
  updateServiceLocation(
    service: ServiceId,
    body: UpdateServiceLocationInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ServiceLocationResource>> {
    return this.put<ServiceLocationResource>(
      `/api/service-location/update/${encodeURIComponent(String(service))}`,
      body,
      opts,
    );
  }
  ...
  showServiceLocation(
    ...
    return this.get<ServiceLocationResource>(
      `/api/service-location/${encodeURIComponent(String(location))}`,
      undefined,
      opts,
    );
  }
