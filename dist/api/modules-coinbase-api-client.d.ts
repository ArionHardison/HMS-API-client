...
import type { CoinbaseWebhookInput, CoinbaseWebhookResource } from '../types/modules-coinbase';
/**
 ...
 */
export declare class CoinbaseModuleApiClient extends BaseApiClient {
    /**
     ...
     */
    webhook(body: CoinbaseWebhookInput, opts?: ApiRequestOptions): Promise<ApiResponse<CoinbaseWebhookResource>>;
}
//# sourceMappingURL=modules-coinbase-api-client.d.ts.map