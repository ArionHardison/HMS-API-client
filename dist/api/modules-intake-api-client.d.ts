 ...
 * via `{ auth: false }`.
 */
export declare class IntakeModuleApiClient extends BaseApiClient {
    /**
     ...
     */
    start(body?: IntakeStartBody, opts?: ApiRequestOptions): Promise<ApiResponse<IntakeStartResponse>>;
    /**
     ...
     */
    exchange(token: string, body?: Record<string, unknown>, opts?: ApiRequestOptions): Promise<ApiResponse<IntakeExchangeResponse>>;
    /**
     ...
     */
    voiceRecord(intake: number | string, body: Record<string, unknown> | FormData, opts?: ApiRequestOptions): Promise<ApiResponse<IntakeResponse>>;
    /**
     ...
     * recording is done.
     */
    voiceFinalize(intake: number | string, body?: Record<string, unknown>, opts?: ApiRequestOptions): Promise<ApiResponse<IntakeResponse>>;
    /**
     * POST `/api/v1/intake/{intake}/answers` — submit structured answers
     * for the current intake. Bearer required.
     */
    submitAnswers(intake: number | string, body: IntakeAnswersBody, opts?: ApiRequestOptions): Promise<ApiResponse<IntakeResponse>>;
    /**
     * POST `/api/v1/intake/{intake}/audience` — set the audience for the
     * intake (which subproject / role tier the intake targets). Bearer
     * required.
     */
    setAudience(intake: number | string, body: IntakeAudienceBody, opts?: ApiRequestOptions): Promise<ApiResponse<IntakeResponse>>;
    /**
     ...
     */
    initiateHandoff(intake: number | string, body?: IntakeHandoffBody, opts?: ApiRequestOptions): Promise<ApiResponse<IntakeResponse>>;
    /**
     * GET `/api/v1/intake/{intake}/status` — current intake progress /
     * completion state. Bearer required. Suitable for polling.
     */
    getStatus(intake: number | string, opts?: ApiRequestOptions): Promise<ApiResponse<IntakeResponse>>;
}
//# sourceMappingURL=modules-intake-api-client.d.ts.map