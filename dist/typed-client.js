...
exports.createTypedApiClient = exports.TypedApiClient = void 0;
/**
...
const operation_index_1 = require("./generated/operation-index");
class TypedApiClient extends api_client_1.BaseApiClient {
    constructor(config = {}) {
        super(config);
        const ops = {};
        for (const id of Object.keys(operation_index_1.operationIndex)) {
    ...
    async call(id, req, opts) {
        ...
        const meta = operation_index_1.operationIndex[id];
        if (!meta) {
...
exports.TypedApiClient = TypedApiClient;
/**
...
function createTypedApiClient(config = {}) {
    return new TypedApiClient(config);
}
exports.createTypedApiClient = createTypedApiClient;
