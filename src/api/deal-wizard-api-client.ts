...
export class DealWizardApiClient extends BaseApiClient {
   ...
   */
  async defineDeal(
    body: DefineDealRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<DealMutationResponse>> {
    return this.post<DealMutationResponse>(
  ...
  async getStatus(dealId: string): Promise<ApiResponse<DealResource>> {
    return this.get<DealResource>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/status`,
    );
  }
  ...
  async getEvents(
    dealId: string,
    query?: DealEventsQuery,
  ): Promise<ApiResponse<DealEventsResponse>> {
    const params =
      query?.per_page === undefined ? undefined : { per_page: query.per_page };
    return this.get<DealEventsResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/events`,
      params,
    );
  }
  ...
  async submitRequiredInfo(
    dealId: string,
    body: RequiredInfoRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<DealMutationResponse>> {
    return this.post<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/required-info`,
      body,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async codify(
    ...
    return this.post<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/codify`,
      undefined,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async selectSolution(
    ...
    return this.post<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/select-solution`,
      body,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async setup(
    ...
    return this.post<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/setup`,
      undefined,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async start(
    ...
    return this.post<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/start`,
      undefined,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async patchMetadata(
    ...
    return this.patch<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/metadata`,
      body,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async patchDetails(
    dealId: string,
    body: PatchDetailsRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<DealMutationResponse>> {
    return this.patch<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/details`,
      body,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async uploadFile(
    ...
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<DealFileResource>> {
    return this.post<DealFileResource>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/files`,
      body,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async deleteFile(
    ...
    return this.delete<null>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/files/${encodeURIComponent(String(fileId))}`,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async patchPath(
    dealId: string,
    body: PatchPathRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<DealMutationResponse>> {
    return this.patch<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/path`,
      body,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async submit(
    ...
    return this.post<DealMutationResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/submit`,
      undefined,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async computeDeposit(
    dealId: string,
    body: ComputeDepositRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<ComputeDepositResponse>> {
    return this.post<ComputeDepositResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/compute-deposit`,
      body,
      withIdempotency(idempotencyKey, opts),
    );
  }
  ...
  async verifyOutcome(
    ...
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<VerifyOutcomeResponse>> {
    return this.post<VerifyOutcomeResponse>(
      `/api/wizard/deal/${encodeURIComponent(dealId)}/verify/${encodeURIComponent(String(executionId))}`,
      undefined,
      withIdempotency(idempotencyKey, opts),
    );
  }
