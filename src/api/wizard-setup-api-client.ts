...
export class WizardSetupApiClient extends BaseApiClient {
  ...
  async getAssessmentAnswers(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/assessment/answers/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async getAssessmentQuestions(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/assessment/questions/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async completeProfile(
    protocol: number | string,
    body: WizardCompleteProfileRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/complete-profile/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async confirmAccount(
    protocol: number | string,
    body: WizardConfirmAccountRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/confirm-account/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async confirmCode(
    protocol: number | string,
    body: WizardConfirmCodeRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/confirm-code/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async confirmPreview(
    protocol: number | string,
    body: WizardConfirmPreviewRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/confirm-preview/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async submitCreatorRequest(
    protocol: number | string,
    body: WizardCreatorRequestPayload,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/creator-request/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async connectStripe(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/connect-stripe/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async verifyStripe(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/verify-stripe/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async getFinances(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/finances/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async setFinances(
    protocol: number | string,
    body: WizardSetFinancesRequest = {},
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/set-finances/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async getFinalizationState(
    protocol: number | string,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.get<WizardSetupResponse>(
      `/api/wizard/finalization-state/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async getWizardState(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/get-state/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async getProgramData(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/program-data/${encodeURIComponent(String(protocol))}`,
    );
  }

  /** GET /api/wizard/public-program-created/{protocol} */
  async getPublicProgramCreated(
    protocol: number | string,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.get<WizardSetupResponse>(
      `/api/wizard/public-program-created/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async retryCreation(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/retry-creation/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async startProgram(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/start-program/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async stepBack(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/step-back/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async findMembers(
    body: WizardFindMembersRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>('/api/wizard/find-members', body);
  }
  ...
  async getRequiredRoles(
    ...
    return this.get<WizardSetupResponse>(
      `/api/wizard/get-required-roles/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async inviteMembers(
    protocol: number | string,
    body: WizardInviteMembersRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/invite-members/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async inviteUsers(
    protocol: number | string,
    body: WizardInviteUsersRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/invite-users/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }

  /** GET /api/wizard/team/roles-to-invite/{protocol} */
  async getRolesToInvite(
    protocol: number | string,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.get<WizardSetupResponse>(
      `/api/wizard/team/roles-to-invite/${encodeURIComponent(String(protocol))}`,
    );
  }
  ...
  async publishProgram(
    protocol: number | string,
    body: WizardPublishProgramRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/publish-program/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async setAgent(
    protocol: number | string,
    body: WizardSetAgentRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/set-agent/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }

  /** POST /api/wizard/set-distribution-type/{protocol} */
  async setDistributionType(
    protocol: number | string,
    body: WizardSetDistributionTypeRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
    return this.post<WizardSetupResponse>(
      `/api/wizard/set-distribution-type/${encodeURIComponent(String(protocol))}`,
      body,
    );
  }
  ...
  async validateEmail(
    body: WizardValidateEmailRequest,
  ): Promise<ApiResponse<WizardSetupResponse>> {
