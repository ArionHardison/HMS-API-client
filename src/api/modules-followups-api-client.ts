 ...
 */
export class FollowUpsModuleApiClient extends BaseApiClient {
  // ---------------------------------------------------------------------------
  // follow-up resource
  // ---------------------------------------------------------------------------

  /** GET `/api/follow-up`. (`follow-up.index`) */
  listFollowUps(opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpResource[]>> {
    return this.get<FollowUpResource[]>('/api/follow-up', undefined, opts);
  }
  ...
  ): Promise<ApiResponse<FollowUpResource>> {
    return this.post<FollowUpResource>('/api/follow-up', body, opts);
  }

  /** GET `/api/follow-up/{follow_up}`. (`follow-up.show`) */
  showFollowUp(followUp: FollowUpId, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpResource>> {
    return this.get<FollowUpResource>(`/api/follow-up/${encodeURIComponent(String(followUp))}`, undefined, opts);
  }

  /** PUT `/api/follow-up/{follow_up}`. (`follow-up.update`) */
  updateFollowUp(
    followUp: FollowUpId,
    body: Partial<CreateFollowUpInput>,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<FollowUpResource>> {
    return this.put<FollowUpResource>(`/api/follow-up/${encodeURIComponent(String(followUp))}`, body, opts);
  }

  /** DELETE `/api/follow-up/{follow_up}`. (`follow-up.destroy`) */
  destroyFollowUp(followUp: FollowUpId, opts?: ApiRequestOptions): Promise<ApiResponse<null>> {
    return this.delete<null>(`/api/follow-up/${encodeURIComponent(String(followUp))}`, opts);
  }
  ...
  finishFollowUp(id: FollowUpId, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpResource>> {
    return this.get<FollowUpResource>(`/api/follow-up/finish/${encodeURIComponent(String(id))}`, undefined, opts);
  }

  /** GET `/api/follow-up/get-current-followup`. (`get.api.follow-up.get-current-followup`) */
  getCurrentFollowUp(opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpResource>> {
    return this.get<FollowUpResource>('/api/follow-up/get-current-followup', undefined, opts);
  }

  /** GET `/api/follow-up/get-data/{chain}`. (`get.api.follow-up.get-data.item`) */
  getFollowUpData(
    chain: FollowUpChainId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<FollowUpResource>> {
    return this.get<FollowUpResource>(
      `/api/follow-up/get-data/${encodeURIComponent(String(chain))}`,
      undefined,
      opts,
    );
  }
  ...
  getFollowUpTimeline(
    chain: FollowUpChainId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<FollowUpTimelineEntry[]>> {
    return this.get<FollowUpTimelineEntry[]>(
      `/api/follow-up/get-timeline/${encodeURIComponent(String(chain))}`,
      undefined,
      opts,
    );
  }
  ...
  handleRecommendation(
    ...
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<FollowUpRecommendationResource>> {
    return this.get<FollowUpRecommendationResource>(
      `/api/follow-up/handle-recommendation/${encodeURIComponent(String(recommendation))}/${encodeURIComponent(status)}`,
      undefined,
      opts,
    );
  }
  ...
  followUpPayment(
    followup: FollowUpInstanceId,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<FollowUpPaymentResource>> {
    return this.get<FollowUpPaymentResource>(
      `/api/follow-up/payment/${encodeURIComponent(String(followup))}`,
      undefined,
      opts,
    );
  }
  ...
  followUpRecommendations(
    ...
    return this.get<FollowUpRecommendationResource[]>(
      `/api/follow-up/recommendations/${encodeURIComponent(String(followup))}`,
      undefined,
      opts,
    );
  }
  ...
  runFollowUp(
    ...
    return this.get<FollowUpResource>(
      `/api/follow-up/run/${encodeURIComponent(String(chain))}`,
      undefined,
      opts,
    );
  }
  ...
  voiceFinalize(
    body: VoiceFinalizeInput,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<VoiceFinalizeResource>> {
    return this.post<VoiceFinalizeResource>('/api/follow-up/voice-finalize', body, opts);
  }
   ...
   */
  voiceRecord(body: VoiceRecordInput, opts?: ApiRequestOptions): Promise<ApiResponse<VoiceFinalizeResource>> {
    return this.post<VoiceFinalizeResource>('/api/follow-up/voice-record', body, opts);
  }
}
