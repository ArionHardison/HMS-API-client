...
export class HitlApiClient extends BaseApiClient {
  ...
  async requestApproval(
    body: HitlRequestedRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<HitlRequestedResponse>> {
    return this.post<HitlRequestedResponse>(
  ...
  async resume(
    ...
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<HitlResumeResponse>> {
    return this.post<HitlResumeResponse>(
