 ...
 */
function isRetryableRequest(method, status, hasIdempotencyKey) {
...
class ChatApiClient extends BaseApiClient {
     ...
     * @param search - Search query
     */
    async listMessages(conversationId, search) {
...
class DomainApiClient extends BaseApiClient {
     ...
     * @param hostname - Domain hostname
     */
    async getConfiguration(hostname) {
...
exports.DomainApiClient = DomainApiClient;
// =================== COMBINED API CLIENT =====================
/**
