...
import type { H5iChannelResponse, H5iMessage, H5iMessageKind, H5iMessagePriority, H5iPublicBroadcastAuthRequest, H5iPublicBroadcastAuthResponse, H5iPublicMessagesResponse, H5iSeedDemoResponse, H5iShowMessageResponse, InboxH5iMessageQuery, InboxH5iMessageResponse, StoreH5iMessageRequest, StoreH5iMessageResponse } from '../types/h5i';
export type { H5iChannelResponse, H5iMessage, H5iMessageKind, H5iMessagePriority, H5iPublicBroadcastAuthRequest, H5iPublicBroadcastAuthResponse, H5iPublicMessagesResponse, H5iSeedDemoResponse, H5iShowMessageResponse, InboxH5iMessageQuery, InboxH5iMessageResponse, StoreH5iMessageRequest, StoreH5iMessageResponse, };
export declare class H5iApiClient extends BaseApiClient {
    /**
     ...
     */
    sendMessage(body: StoreH5iMessageRequest, opts?: ApiRequestOptions): Promise<ApiResponse<StoreH5iMessageResponse>>;
    /**
     ...
     */
    getInbox(query: InboxH5iMessageQuery): Promise<ApiResponse<InboxH5iMessageResponse>>;
    /**
     * GET /api/h5i/msg/channel/{channel} — full channel history.
     * `limit` (1..500) is clamped server-side (default 100).
     */
    getChannel(channel: string, limit?: number): Promise<ApiResponse<H5iChannelResponse>>;
    /** GET /api/h5i/msg/{id} — fetch one message by its 16-hex id. */
    getMessage(id: string): Promise<ApiResponse<H5iShowMessageResponse>>;
    /**
     ...
     */
    seedDemo(guid: string, opts?: ApiRequestOptions): Promise<ApiResponse<H5iSeedDemoResponse>>;
    /**
     ...
     * `guid` is a strict UUID v4.
     */
    getPublicMessages(guid: string, limit?: number): Promise<ApiResponse<H5iPublicMessagesResponse>>;
    /**
     ...
     */
    publicBroadcastAuth(body: H5iPublicBroadcastAuthRequest): Promise<ApiResponse<H5iPublicBroadcastAuthResponse>>;
}
//# sourceMappingURL=h5i-api-client.d.ts.map