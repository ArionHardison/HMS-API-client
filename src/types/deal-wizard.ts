...
// =============================================================================
// DealResource — the full snapshot returned by most wizard endpoints.
// Mirrors Modules/Deals/Http/Resources/DealResource::toArray().
// =============================================================================
...
// FormRequest: DefineDealRequest { statement: required|string|min:1|max:8000,
//                                  tld: nullable|string|max:64 }
// Controller forwards any extra keys (e.g. problem.intent_slug) into the
...
// =============================================================================
// POST /api/wizard/deal/{deal_id}/required-info
// Inline validation: `answers` must be an object of {key:value}; every
// required key declared in problem.required_info must be answered.
// =============================================================================
...
// =============================================================================
// POST /api/wizard/deal/{deal_id}/codify   — no request body (LLM-driven).
// On the deals.step2_strict_schema flag a generation failure returns 502.
// =============================================================================
...
// =============================================================================
// POST /api/wizard/deal/{deal_id}/select-solution
// Inline validation: `solution_idx` must be an integer in range.
// =============================================================================
...
// =============================================================================
// POST /api/wizard/deal/{deal_id}/setup    — no request body.
// POST /api/wizard/deal/{deal_id}/start    — no request body.
// =============================================================================

// =============================================================================
// PATCH /api/wizard/deal/{deal_id}/metadata
// validate: title required|string|max:255; description required|string|min:50
//   |max:5000; applicant_type required|in:Builder,Organizer,Promoter;
//   related_industries nullable|array.
// =============================================================================
...
// =============================================================================
// PATCH /api/wizard/deal/{deal_id}/details
// validate: customer_user_id nullable|integer|exists; start_date nullable|date;
//   end_date nullable|date|after_or_equal:start_date;
//   budget_tier required|in:lt5k,lt30k,lt100k,gte100k.
// =============================================================================
...
// =============================================================================
// POST /api/wizard/deal/{deal_id}/files  (multipart)
// validate: file required|file|max:10240(KB); file_type required|
//   in:document,image,logo.  Response 201 = the DealFile row (->toArray()).
// =============================================================================
...
// =============================================================================
// PATCH /api/wizard/deal/{deal_id}/path
// validate: path_tier required|in:pink,green,blue,red,black.
// =============================================================================
...
// =============================================================================
// POST /api/wizard/deal/{deal_id}/submit  — no body; gates on intake data.
// =============================================================================
...
// =============================================================================
// POST /api/wizard/deal/{deal_id}/compute-deposit
// validate: amount_cents required|integer|in:100,1000,10000,100000,1000000.
...
// =============================================================================
// POST /api/wizard/deal/{deal_id}/verify/{execution_id}  — no body.
// Synchronous response per DealVerificationController.
// =============================================================================
...
// =============================================================================
// GET /api/wizard/deal/{deal_id}/events  — paginated audit log.
// =============================================================================
