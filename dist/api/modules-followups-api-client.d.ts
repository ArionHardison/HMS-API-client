...
import type { CreateFollowUpInput, FollowUpChainId, FollowUpId, FollowUpInstanceId, FollowUpPaymentResource, FollowUpRecommendationResource, FollowUpResource, FollowUpTimelineEntry, RecommendationId, RecommendationStatus, VoiceFinalizeInput, VoiceFinalizeResource, VoiceRecordInput } from '../types/modules-followups';
/**
 ...
 */
export declare class FollowUpsModuleApiClient extends BaseApiClient {
    ...
    createFollowUp(body: CreateFollowUpInput, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpResource>>;
    ...
    updateFollowUp(followUp: FollowUpId, body: Partial<CreateFollowUpInput>, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpResource>>;
    ...
    getFollowUpData(chain: FollowUpChainId, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpResource>>;
    /** GET `/api/follow-up/get-timeline/{chain}`. (`get.api.follow-up.get-timeline.item`) */
    getFollowUpTimeline(chain: FollowUpChainId, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpTimelineEntry[]>>;
    /** GET `/api/follow-up/handle-recommendation/{recommendation}/{status}`. */
    handleRecommendation(recommendation: RecommendationId, status: RecommendationStatus, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpRecommendationResource>>;
    /** GET `/api/follow-up/payment/{followup}`. (`get.api.follow-up.payment.item`) */
    followUpPayment(followup: FollowUpInstanceId, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpPaymentResource>>;
    /** GET `/api/follow-up/recommendations/{followup}`. (`get.api.follow-up.recommendations.item`) */
    followUpRecommendations(followup: FollowUpInstanceId, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpRecommendationResource[]>>;
    /** GET `/api/follow-up/run/{chain}`. (`get.api.follow-up.run.item`) */
    runFollowUp(chain: FollowUpChainId, opts?: ApiRequestOptions): Promise<ApiResponse<FollowUpResource>>;
    /** POST `/api/follow-up/voice-finalize`. (`post.api.follow-up.voice-finalize`) */
    voiceFinalize(body: VoiceFinalizeInput, opts?: ApiRequestOptions): Promise<ApiResponse<VoiceFinalizeResource>>;
    /**
...
//# sourceMappingURL=modules-followups-api-client.d.ts.map