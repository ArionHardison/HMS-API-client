...
exports.getUserFeaturedProgramsExample = exports.getUserProgramsExample = exports.getProgramCategoriesExample = exports.getBookmarksExample = exports.toggleBookmarkExample = exports.searchProgramsExample = exports.getProgramFeedbackExample = exports.getProgramExample = exports.getRecentProgramsExample = exports.getFeaturedProgramsExample = void 0;
 ...
 */
async function getFeaturedProgramsExample() {
    try {
        const response = await api_1.hmsApiClient.programs.getFeaturedPrograms();
...
exports.getFeaturedProgramsExample = getFeaturedProgramsExample;
/**
 * Get Recent Programs Example
 *
 * This example demonstrates how to retrieve recent programs.
 */
async function getRecentProgramsExample() {
    try {
        const response = await api_1.hmsApiClient.programs.getRecentPrograms();
        if (response.data.success) {
            const programs = response.data.data;
...
exports.getRecentProgramsExample = getRecentProgramsExample;
/**
 * Get Program Details Example
 *
 * This example demonstrates how to retrieve a specific program.
 */
async function getProgramExample(programId) {
    try {
        const response = await api_1.hmsApiClient.programs.getProgram(programId);
        if (response.data.success) {
...
exports.getProgramExample = getProgramExample;
/**
 * Get Program Feedback Example
 *
 * This example demonstrates how to retrieve feedback for a program.
 */
async function getProgramFeedbackExample(programId) {
    try {
        const response = await api_1.hmsApiClient.programs.getProgramFeedback(programId);
        if (response.data.success) {
...
exports.getProgramFeedbackExample = getProgramFeedbackExample;
/**
 * Search Programs Example
 *
 * This example demonstrates how to search for programs.
 */
async function searchProgramsExample(query, categoryId) {
    try {
        const response = await api_1.hmsApiClient.programs.searchPrograms(query, categoryId);
        if (response.data.success) {
            const programs = response.data.data;
...
exports.searchProgramsExample = searchProgramsExample;
/**
 * Toggle Program Bookmark Example
 *
 * This example demonstrates how to bookmark and unbookmark a program.
 */
async function toggleBookmarkExample(programId) {
    try {
        const response = await api_1.hmsApiClient.programs.toggleBookmark(programId);
        if (response.data.success) {
...
exports.toggleBookmarkExample = toggleBookmarkExample;
/**
 * Get Bookmarked Programs Example
 *
 * This example demonstrates how to retrieve bookmarked programs.
 */
async function getBookmarksExample() {
    try {
        const response = await api_1.hmsApiClient.programs.getBookmarks();
        if (response.data.success) {
            const programs = response.data.data;
...
exports.getBookmarksExample = getBookmarksExample;
/**
 * Get Program Categories Example
 *
 * This example demonstrates how to retrieve program categories.
 */
async function getProgramCategoriesExample() {
    try {
        const response = await api_1.hmsApiClient.programs.getCategories();
        if (response.data.success) {
...
exports.getProgramCategoriesExample = getProgramCategoriesExample;
/**
 * Get User Programs Example
 *
 * This example demonstrates how to retrieve programs by a specific user.
 */
async function getUserProgramsExample(userId) {
    try {
        const response = await api_1.hmsApiClient.programs.getUserPrograms(userId);
        if (response.data.success) {
            const programs = response.data.data;
...
exports.getUserProgramsExample = getUserProgramsExample;
/**
 * Get User's Featured Programs Example
 *
 * This example demonstrates how to retrieve featured programs by a specific user.
 */
async function getUserFeaturedProgramsExample(userId) {
    try {
        const response = await api_1.hmsApiClient.programs.getUserFeaturedPrograms(userId);
        if (response.data.success) {
            const programs = response.data.data;
...
exports.getUserFeaturedProgramsExample = getUserFeaturedProgramsExample;
