...
export class IntegrationsApiClient extends BaseApiClient {
  ...
  async upsertIbdUser(
    ...
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<UserUpsertResponse>> {
    return this.post<UserUpsertResponse>(
   ...
   */
  async upsertCareersUser(
    body: CareersUserUpsertRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<CareersUserUpsertResponse>> {
    return this.post<CareersUserUpsertResponse>(
   ...
   * 'accepted' }`.
   */
  async createIbdApplication(
    body: IbdApplicationRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<EventLogAcceptedResponse>> {
    return this.post<EventLogAcceptedResponse>(
   ...
   * (kind `kpi_event`).
   */
  async createIbdKpiEvent(
    body: IbdKpiEventRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<EventLogAcceptedResponse>> {
    return this.post<EventLogAcceptedResponse>(
   ...
   */
  async batchMobActivityLocations(
    body: MobActivityLocationBatchRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<EventLogAcceptedResponse>> {
    return this.post<EventLogAcceptedResponse>(
   ...
   */
  async completeMobRun(
    body: MobRunCompleteRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<EventLogAcceptedResponse>> {
    return this.post<EventLogAcceptedResponse>(
   ...
   */
  async createNioAssessmentResponse(
    body: NioAssessmentResponseRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<EventLogAcceptedResponse>> {
    return this.post<EventLogAcceptedResponse>(
   ...
   */
  async createNioOrder(
    body: NioOrderRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<EventLogAcceptedResponse>> {
    return this.post<EventLogAcceptedResponse>(
   ...
   */
  async grantNioCoins(
    body: NioCoinGrantRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<NioCoinTransactionResponse>> {
    return this.post<NioCoinTransactionResponse>(
   ...
   */
  async nioFirebaseLogin(
    body: NioFirebaseLoginRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<NioFirebaseLoginResponse>> {
    return this.post<NioFirebaseLoginResponse>(
      '/api/v1/integrations/nio/firebase-login',
      body as unknown as Record<string, unknown>,
      withIdempotency(idempotencyKey, { auth: false, ...(opts ?? {}) }),
    );
  }
   ...
   */
  async mobGuestRegister(
    body: MobGuestRegisterRequest,
    idempotencyKey?: string,
    opts?: ApiRequestOptions,
  ): Promise<ApiResponse<MobGuestRegisterResponse>> {
    return this.post<MobGuestRegisterResponse>(
