...
exports.deleteChatExample = exports.deleteMessageExample = exports.findUserToChatExample = exports.sendMessageExample = exports.getChatMessagesExample = exports.getChatRoomExample = exports.getChatListExample = void 0;
 ...
 */
async function getChatListExample(search) {
    try {
        const response = await api_1.hmsApiClient.chat.getChatList(search);
...
exports.getChatListExample = getChatListExample;
/**
 * Get Chat Room Example
 *
 * This example demonstrates how to retrieve or create a 1:1 chat room with a user.
 */
async function getChatRoomExample(userId) {
    try {
        const response = await api_1.hmsApiClient.chat.getChatRoom(userId);
        if (response.data.success) {
...
exports.getChatRoomExample = getChatRoomExample;
/**
 * Get Chat Messages Example
 *
 * This example demonstrates how to retrieve messages from a chat room.
 */
async function getChatMessagesExample(chatId, search) {
    try {
        const response = await api_1.hmsApiClient.chat.getMessages(chatId, search);
        if (response.data.success) {
...
exports.getChatMessagesExample = getChatMessagesExample;
/**
 * Send Message Example
 *
 * This example demonstrates how to send a message to a chat room.
 */
async function sendMessageExample(roomId, message, attachments) {
    try {
        const response = await api_1.hmsApiClient.chat.sendMessage({
            roomId,
            message,
            attachments
        });
...
exports.sendMessageExample = sendMessageExample;
/**
 * Find User to Chat With Example
 *
 * This example demonstrates how to search for users to chat with.
 */
async function findUserToChatExample(search) {
    try {
        const response = await api_1.hmsApiClient.chat.findUserToChat(search);
        if (response.data.success) {
...
exports.findUserToChatExample = findUserToChatExample;
/**
 * Delete Message Example
 *
 * This example demonstrates how to delete a message.
 */
async function deleteMessageExample(messageId) {
    try {
        const response = await api_1.hmsApiClient.chat.deleteMessage(messageId);
        if (response.data.success) {
...
exports.deleteMessageExample = deleteMessageExample;
/**
 * Delete Chat Example
 *
 * This example demonstrates how to delete a chat room.
 */
async function deleteChatExample(chatId) {
    try {
        const response = await api_1.hmsApiClient.chat.deleteChat(chatId);
        if (response.data.success) {
...
exports.deleteChatExample = deleteChatExample;
