...
exports.wizardSteps = exports.WizardStepExecutor = exports.wizardApiClient = exports.WizardApiClient = exports.JobStatus = exports.PayoutStatus = exports.FeasibilityRating = exports.WizardStep = void 0;
const hms_api_client_1 = require("./hms-api-client");
/**
 * Wizard Step enum
 */
var WizardStep;
...
})(FeasibilityRating || (exports.FeasibilityRating = FeasibilityRating = {}));
/**
 * Payout Status enum
 */
var PayoutStatus;
 ...
 */
class WizardApiClient extends hms_api_client_1.BaseApiClient {
    /**
...
exports.WizardApiClient = WizardApiClient;
// Create default instance with auto-configuration
exports.wizardApiClient = new WizardApiClient({
...
exports.WizardStepExecutor = WizardStepExecutor;
/**
 * Create type-safe step handlers
 */
exports.wizardSteps = {
    defineProblems: new WizardStepExecutor(exports.wizardApiClient, (dealId, data) => exports.wizardApiClient.defineProblems(dealId, data)),
    codifySolution: new WizardStepExecutor(exports.wizardApiClient, (dealId, data) => exports.wizardApiClient.codifySolution(dealId, data)),
    setupProgram: new WizardStepExecutor(exports.wizardApiClient, (dealId, data) => exports.wizardApiClient.setupProgram(dealId, data)),
    executeProgram: new WizardStepExecutor(exports.wizardApiClient, (dealId, data) => exports.wizardApiClient.executeProgram(dealId, data)),
    verifyOutcome: new WizardStepExecutor(exports.wizardApiClient, (dealId, data) => exports.wizardApiClient.verifyOutcome(dealId, data))
};
