...
exports.dealTemplateToMermaid = void 0;
/**
 ...
 */
function sanitize(text, maxLen = 80) {
 ...
 */
function collectParticipants(template) {
    const seen = new Map();
 ...
 * step output.
 */
function inputSourceAlias(step, byStep) {
    ...
    for (const ref of inputs) {
        ...
        if (m) {
            ...
            if (sourceStep?.actor)
                return aliasFor(sourceStep.actor);
        }
    }
    return null;
}
function dealTemplateToMermaid(template) {
    const lines = [];
...
exports.dealTemplateToMermaid = dealTemplateToMermaid;
//# sourceMappingURL=deal-template-to-mermaid.js.map